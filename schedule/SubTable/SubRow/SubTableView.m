...
- (void)configureInsideTableView {
    ...
    insideTableView.allowsSelection = NO;
    
    insideTableView.backgroundColor = [UIColor whiteColor];
    insideTableView.opaque = YES;
    insideTableView.separatorStyle = UITableViewCellSeparatorStyleNone;
...
- (void)setDelegate:(id<SubTableViewCellDelegate>)deleg {
    ...
    insideTableView.frame = CGRectMake(0, 16, self.contentView.frame.size.width, rowHeight * numberOfChild);
}
